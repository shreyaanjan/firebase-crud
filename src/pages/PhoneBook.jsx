            ...
            <div className="max-w-screen-xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
                    ...
                    <button
                        ...
                        className="text-white bg-gradient-to-br from-blue-600 to-blue-800 hover:from-blue-700 hover:to-blue-900 
                                   focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold uppercase rounded-lg 
                                   text-sm sm:text-base px-4 sm:px-6 py-1.5 sm:py-2 w-auto sm:w-auto transform transition-all duration-300 ease-in-out"
                    >
                        Add Contact
                    </button>
                </div>
                ...
                {/* Table */}
                <div className="relative overflow-x-auto shadow-md sm:rounded-lg p-2 sm:p-4">
                            ...
                            {contact.map((user) => (
                                <tr key={user.id} className="bg-white text-gray-900 !border-b !border-gray-300">
                                    ...
                                    <td className="flex items-center gap-5 px-6 py-4">
                                        <Link
                                            to={`/edit-contact/${user.id}`}
                                            className="text-lg text-green-600 dark:text-green-500 hover:underline"
                                        >
